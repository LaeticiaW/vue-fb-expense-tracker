...
export default {
  async reloadCategoryData() {
    ...
    await setDoc(doc(db, 'categories', '5e861fdaa52672a5d4727ba2'), {
      _id: '5e861fdaa52672a5d4727ba2',
      name: 'Entertainment',
      subcategories: [
        { id: '278e848f-a17b-40c0-998a-a378265e8af1', name: 'Amazon Prime', matchText: ['Prime Video'] },
        { id: 'b0b569d4-5e45-4a46-8532-4037799e2984', name: 'NetFlix', matchText: ['Netflix'] }
      ]
    })

    await setDoc(doc(db, 'categories', '5e861fdaa52672a5d4727ba5'), {
      _id: '5e861fdaa52672a5d4727ba5',
      name: 'Auto',
      subcategories: [
        ...
        { id: '5de64c34-2c65-49b6-9e2e-851d636c623c', name: 'Tolls', matchText: ['NC Quick Pass'] }
      ]
    })

    await setDoc(doc(db, 'categories', '5e861fdaa52672a5d4727ba6'), {
      _id: '5e861fdaa52672a5d4727ba6',
      name: 'Groceries',
      subcategories: [
        { id: 'b2bb1c1b-31fb-473a-a12c-f6d41ad43e3d', name: 'Costco', matchText: ['Costco'] },
        { id: '7', name: 'Food Lion', matchText: ['Food Lion'] },
        { id: '2', name: 'Harris Teeter', matchText: ['Harris Teeter', 'HarrisTeeter'] },
        { id: '2fe9b764-cb3b-45fb-8b42-064c5150595a', name: "Trader Joe's", matchText: ["Trader Joe's"] },
        { id: '36cdfa12-b86c-4c63-9be6-2a030629df1f', name: 'Whole Foods', matchText: ['WHOLEFDS'] }
      ]
    })

    await setDoc(doc(db, 'categories', '5e95f54bb208626f3d10bd5f'), {
      _id: '5e95f54bb208626f3d10bd5f',
      name: 'Lawn & Garden',
      subcategories: [
        { id: '1941659a-f18e-4799-bf3f-7c6670e579ba', name: 'Lawn', matchText: ['Lawn Doctor'] },
        {
          id: 'dac57ae9-97b9-4ef3-92b5-b43804fc7c0e',
          name: 'Plants/Mulch',
          matchText: ['Big Bloomers', 'For Gardens Sake', 'Garden Supply', 'GrowingWild', 'Kiefer Landscaping', 'Lowes']
        }
      ]
    })

    await setDoc(doc(db, 'categories', '5e98904f990b7282f49e824d'), {
      _id: '5e98904f990b7282f49e824d',
      name: 'Utilities',
      subcategories: [
        { id: '4325bc4d-83e3-4a61-9564-c44b3208afd1', name: 'Electric' },
        { id: '0339124a-75c1-4cdf-8002-1d7edd532a64', name: 'Gas', matchText: ['Valero'] },
        { id: 'cc132225-48cf-4873-9058-d6e6bd506949', name: 'Internet', matchText: ['Spectrum'] },
        { id: 'f036a7fd-46b9-4b56-8210-6c44665856a8', name: 'Phone', matchText: ['VZWRLSS'] }
      ]
    })

    await setDoc(doc(db, 'categories', '5ed1562ceca66f3f22527528'), {
      _id: '5ed1562ceca66f3f22527528',
      name: 'Travel',
      subcategories: [
